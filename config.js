...
window.CLUB = {
  ...
  contacts: {
    ...
    ilhan: { prenom: "Ilhan", nom: "Ilhan", handle: "", abonnes: "", photo: "", lien: "",   // page créée le 21/09 (demande Tony) : pseudo, photo HD, abonnés, 4 FAQ et couleurs à venir ; DA par défaut en attendant
             ...
             resultatsTitre: "Ce que les membres m'écrivent.",
             resultatsSous: "Touche une capture pour l'agrandir." },
    ilona: { prenom: "Ilona", nom: "Ilona Bessire", handle: "ilona.bessire", abonnes: "37K", photo: "ilona.jpg?v=105", photoGrande: "ilona-grande.jpg", lien: "https://ig.me/m/ilona.bessire",   // pseudo et photo reçus le 22/09 ; nom déduit du pseudo ; 37K d'après la note du 17/09, à confirmer ; certification à confirmer
